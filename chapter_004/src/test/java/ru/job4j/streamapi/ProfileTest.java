...
public class ProfileTest {
    ...
    public void whenProfileAddressSearch() {
        List<Profile> profiles = List.of(new Profile(new Address("Санкт-Петербург", "авушкина", 18, 84)),
                new Profile(new Address("Москва", "Ленина", 154, 24)),
        ...
        List<Address> expected = List.of(new Address("Москва", "Ленина", 154, 24),
                new Address("Санкт-Петербург", "авушкина", 18, 84));
